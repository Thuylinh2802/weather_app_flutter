...
import 'package:weather_app_flutter/Model/weatherDatabase.dart';
  ...
  void fetchWeather(String cityName) async {
    try {
      ...
      final response = await http.get(Uri.parse(
          'https://api.weatherapi.com/v1/forecast.json?key=1dedd839b12947e1963141437231706&q=$cityName&days=7'));
